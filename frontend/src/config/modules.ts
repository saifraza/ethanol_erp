...
export const MODULE_DEFS: ModuleDef[] = [
  ...
  { key: 'transporters', label: 'Transporters', to: '/sales/transporters', icon: Users, group: 'sales' },
  { key: 'transport-orders', label: 'Transport WO', to: '/sales/transport-orders', icon: Truck, group: 'sales' },
...
{ key: 'post-dated-cheques', label: 'PDC Register', to: '/accounts/pdc', icon: FileText, group: 'accounts' },
  ...
  { key: 'work-orders', label: 'Work Orders', to: '/inventory/work-orders', icon: ClipboardCheck, group: 'inventory' },
  ...
  { key: 'biometric-enrollment', label: 'Biometric Enrollment', to: '/hr/biometric-enrollment', icon: Fingerprint, group: 'hr' },
  { key: 'labor-workers', label: 'Labor Workers', to: '/hr/labor-workers', icon: HardHat, group: 'hr' },
  { key: 'labor-attendance', label: 'Labor Attendance', to: '/hr/labor-attendance', icon: CalendarIcon, group: 'hr' },
