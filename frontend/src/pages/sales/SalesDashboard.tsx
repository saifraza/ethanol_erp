            ...
            <div className="p-4 space-y-3">
              ...
              <div className="flex items-center justify-between bg-slate-50 rounded-lg p-3 border">
                <div className="text-sm">
                  <span className="text-gray-600">₹{totals.totalAmount.toLocaleString('en-IN', { maximumFractionDigits: 2 })}</span>
                  <span className="text-gray-400"> + GST ₹{totals.totalGst.toLocaleString('en-IN', { maximumFractionDigits: 2 })}</span>
