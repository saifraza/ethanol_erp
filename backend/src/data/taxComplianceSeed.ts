...
export const TDS_LEDGER_SEED: TdsLedgerSeed[] = [
  ...
  { ledgerCode: '2202', ledgerName: 'TDS Payable - 194J - Royalty/Tech 2%',  tdsSectionCode: '393_ROYALTY_TECH'   },
  { ledgerCode: '2210', ledgerName: 'TDS Payable - 194J - Professional 10%', tdsSectionCode: '393_PROFESSIONAL'  },
  ...
  { ledgerCode: '2206', ledgerName: 'TDS Payable - 194A - Interest (Bank)',   tdsSectionCode: '393_INTEREST_BANK'  },
  { ledgerCode: '2211', ledgerName: 'TDS Payable - 194A - Interest (Other)', tdsSectionCode: '393_INTEREST_OTHER' },
...
export const TDS_SEED: TdsSectionSeed[] = [
  ...
  {
    code: '393_ROYALTY_TECH',
    newSection: '393',
    oldSection: '194J',
    nature: 'Royalty / fees for technical services (2%)',
    rateIndividual: 2,
    rateOthers: 2,
    thresholdSingle: 0,
  ...
  },
  {
    ...
    newSection: '393',
    oldSection: '194J',
    nature: 'Professional fees, director remuneration (10%)',
    rateIndividual: 10,
    rateOthers: 10,
    thresholdSingle: 0,
    thresholdAggregate: 50000,
  ...
  {
    code: '393_INTEREST_BANK',
    newSection: '393',
    oldSection: '194A',
    nature: 'Interest — bank / co-op / post office deposits',
    rateIndividual: 10,
    rateOthers: 10,
    thresholdSingle: 0,
    thresholdAggregate: 100000,
  ...
  {
    code: '393_INTEREST_OTHER',
    newSection: '393',
    oldSection: '194A',
    nature: 'Interest — others (non-bank)',
    rateIndividual: 10,
    rateOthers: 10,
    thresholdSingle: 0,
    thresholdAggregate: 10000,
    panMissingRate: 20,
    nonFilerRate: 5,
  },
  {
...
export const TAX_RULE_EXPLANATIONS_SEED: TaxRuleExplanationSeed[] = [
  ...
  {
    ruleKey: 'tds.393.royalty_tech',
    title: 'TDS on royalty / technical services (Section 393, formerly 194J — 2%)',
    plainEnglish:
      'Royalty and fees for technical services attract 2% TDS once aggregate in the year crosses Rs.50,000. This is the lower 194J rate — applies to royalties, call-centre fees, and technical service fees.',
    whatErpDoes:
      'Tags vendors with 393_ROYALTY_TECH section. Tracks aggregate spend against Rs.50,000 ceiling.',
    whatUserDoes:
      'Use this for royalty/technical service vendors. Use 393_PROFESSIONAL for CA, consultants, directors.',
    category: 'DIRECT_TAX',
    sortOrder: 35,
  },
  {
    ruleKey: 'tds.393.professional',
    title: 'TDS on professional fees (Section 393, formerly 194J — 10%)',
    plainEnglish:
      'Fees paid to CA, consultants, directors remuneration, etc., attract 10% TDS once aggregate in the year crosses Rs.50,000. No single-bill threshold.',
    whatErpDoes:
    ...
    whatUserDoes:
      'Mark auditors, consultants, directors, and lab-service providers as professional. Keep their PAN on file.',
    category: 'DIRECT_TAX',
    sortOrder: 40,
  },
  {
