...
import fermentationFillRoutes from './routes/fermentation/fillEvents';
...
import documentClassifierRoutes from './routes/documentClassifier';
...
app.use('/api/fermentation/fills', fermentationFillRoutes);
