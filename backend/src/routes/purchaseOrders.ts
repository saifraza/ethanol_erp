...
router.post('/', validate(createPOSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const po = await prisma.purchaseOrder.create({
      data: {
        ...
        quotationDate: b.quotationDate ? new Date(b.quotationDate) : null,
...
router.put('/:id', validate(updatePOSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
      ...
      const updated = await prisma.$transaction(async (tx) => {
        ...
        return tx.purchaseOrder.update({
          ...
          data: {
            ...
            quotationDate: b.quotationDate !== undefined ? (b.quotationDate ? new Date(b.quotationDate) : null) : po.quotationDate,
            projectName: b.projectName !== undefined ? (b.projectName || null) : po.projectName,
    ...
    const updated = await prisma.purchaseOrder.update({
      ...
      data: {
        ...
        poType: b.poType !== undefined ? b.poType : undefined,
        dealType: b.dealType !== undefined ? b.dealType : undefined,
        quotationNo: b.quotationNo !== undefined ? (b.quotationNo || null) : undefined,
        quotationDate: b.quotationDate !== undefined ? (b.quotationDate ? new Date(b.quotationDate) : null) : undefined,
        projectName: b.projectName !== undefined ? (b.projectName || null) : undefined,
      },
      include: { lines: true },
    });
