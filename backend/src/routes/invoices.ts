...
router.put('/:id', asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  if (b.quantity !== undefined || b.rate !== undefined || b.gstPercent !== undefined || b.freightCharge !== undefined) {
    const quantity = (b.quantity !== undefined ? parseFloat(b.quantity) : invoice.quantity);
    const rate = (b.rate !== undefined ? parseFloat(b.rate) : invoice.rate);
    const gstPercent = (b.gstPercent !== undefined ? parseFloat(b.gstPercent) : invoice.gstPercent);
    const freightCharge = (b.freightCharge !== undefined ? parseFloat(b.freightCharge) : invoice.freightCharge);
