...
router.post('/send-rate-request', asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  const results: Record<string, unknown> = { email: null, telegram: null };
...
router.post('/send-custom', asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.post('/send-document', asyncHandler(async (req: AuthRequest, res: Response) => {
