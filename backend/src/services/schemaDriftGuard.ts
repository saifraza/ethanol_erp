...
const EXPECTED_COLUMNS: ColumnCheck[] = [
  ...
  // its columns. Register every data column (ADD COLUMN IF NOT EXISTS, idempotent)
  // so writes don't 500 on a missing column. Also adds the new manual-aggregate
  // columns (truckCount/qtyPerTruck/estimatedDelivery).
  { table: 'TransportWorkOrder', column: 'transporterName',   sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "transporterName" TEXT NOT NULL DEFAULT ''` },
  { table: 'TransportWorkOrder', column: 'productType',       sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "productType" TEXT NOT NULL DEFAULT 'ETHANOL'` },
  { table: 'TransportWorkOrder', column: 'contractId',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "contractId" TEXT` },
  { table: 'TransportWorkOrder', column: 'contractNo',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "contractNo" TEXT` },
  { table: 'TransportWorkOrder', column: 'customerName',      sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "customerName" TEXT` },
  { table: 'TransportWorkOrder', column: 'depot',             sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "depot" TEXT NOT NULL DEFAULT ''` },
  { table: 'TransportWorkOrder', column: 'distanceKm',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "distanceKm" DOUBLE PRECISION` },
  { table: 'TransportWorkOrder', column: 'estimatedDelivery', sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "estimatedDelivery" TIMESTAMP(3)` },
  { table: 'TransportWorkOrder', column: 'rateBasis',         sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "rateBasis" TEXT NOT NULL DEFAULT 'PER_TRUCK'` },
  { table: 'TransportWorkOrder', column: 'rate',              sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "rate" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'trucksOrdered',     sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "trucksOrdered" INTEGER` },
  { table: 'TransportWorkOrder', column: 'truckCount',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "truckCount" INTEGER` },
  { table: 'TransportWorkOrder', column: 'qtyPerTruck',       sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "qtyPerTruck" DOUBLE PRECISION` },
  { table: 'TransportWorkOrder', column: 'gstPercent',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "gstPercent" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'supplyType',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "supplyType" TEXT` },
  { table: 'TransportWorkOrder', column: 'cgstAmount',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "cgstAmount" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'sgstAmount',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "sgstAmount" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'igstAmount',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "igstAmount" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'gstAmount',         sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "gstAmount" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'tdsPercent',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "tdsPercent" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'tdsAmount',         sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "tdsAmount" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'subtotal',          sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "subtotal" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'totalAmount',       sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "totalAmount" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'netPayable',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "netPayable" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'paidAmount',        sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "paidAmount" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'balanceAmount',     sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "balanceAmount" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrder', column: 'status',            sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "status" TEXT NOT NULL DEFAULT 'DRAFT'` },
  { table: 'TransportWorkOrder', column: 'confirmedAt',       sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "confirmedAt" TIMESTAMP(3)` },
  { table: 'TransportWorkOrder', column: 'confirmedBy',       sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "confirmedBy" TEXT` },
  { table: 'TransportWorkOrder', column: 'cancelledAt',       sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "cancelledAt" TIMESTAMP(3)` },
  { table: 'TransportWorkOrder', column: 'cancelReason',      sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "cancelReason" TEXT` },
  { table: 'TransportWorkOrder', column: 'remarks',           sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "remarks" TEXT` },
  { table: 'TransportWorkOrder', column: 'division',          sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "division" TEXT DEFAULT 'ETHANOL'` },
  { table: 'TransportWorkOrder', column: 'companyId',         sql: `ALTER TABLE "TransportWorkOrder" ADD COLUMN IF NOT EXISTS "companyId" TEXT` },
  { table: 'TransportWorkOrderLine', column: 'sourceType',    sql: `ALTER TABLE "TransportWorkOrderLine" ADD COLUMN IF NOT EXISTS "sourceType" TEXT` },
  { table: 'TransportWorkOrderLine', column: 'sourceId',      sql: `ALTER TABLE "TransportWorkOrderLine" ADD COLUMN IF NOT EXISTS "sourceId" TEXT` },
  { table: 'TransportWorkOrderLine', column: 'dispatchDate',  sql: `ALTER TABLE "TransportWorkOrderLine" ADD COLUMN IF NOT EXISTS "dispatchDate" TIMESTAMP(3)` },
  { table: 'TransportWorkOrderLine', column: 'vehicleNo',     sql: `ALTER TABLE "TransportWorkOrderLine" ADD COLUMN IF NOT EXISTS "vehicleNo" TEXT NOT NULL DEFAULT ''` },
  { table: 'TransportWorkOrderLine', column: 'quantity',      sql: `ALTER TABLE "TransportWorkOrderLine" ADD COLUMN IF NOT EXISTS "quantity" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportWorkOrderLine', column: 'unit',          sql: `ALTER TABLE "TransportWorkOrderLine" ADD COLUMN IF NOT EXISTS "unit" TEXT NOT NULL DEFAULT 'TRUCK'` },
  { table: 'TransportWorkOrderLine', column: 'amount',        sql: `ALTER TABLE "TransportWorkOrderLine" ADD COLUMN IF NOT EXISTS "amount" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportPayment', column: 'transporterId',       sql: `ALTER TABLE "TransportPayment" ADD COLUMN IF NOT EXISTS "transporterId" TEXT` },
  { table: 'TransportPayment', column: 'amount',              sql: `ALTER TABLE "TransportPayment" ADD COLUMN IF NOT EXISTS "amount" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportPayment', column: 'tdsDeducted',         sql: `ALTER TABLE "TransportPayment" ADD COLUMN IF NOT EXISTS "tdsDeducted" DOUBLE PRECISION NOT NULL DEFAULT 0` },
  { table: 'TransportPayment', column: 'paymentMode',         sql: `ALTER TABLE "TransportPayment" ADD COLUMN IF NOT EXISTS "paymentMode" TEXT NOT NULL DEFAULT 'NEFT'` },
  { table: 'TransportPayment', column: 'paymentRef',          sql: `ALTER TABLE "TransportPayment" ADD COLUMN IF NOT EXISTS "paymentRef" TEXT` },
  { table: 'TransportPayment', column: 'paymentDate',         sql: `ALTER TABLE "TransportPayment" ADD COLUMN IF NOT EXISTS "paymentDate" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP` },
  ...
  // sales). Header + per-truck lines + payments. See routes/transportWorkOrders.ts.
  {
    ...
    sql: `
      CREATE TABLE IF NOT EXISTS "TransportWorkOrder" (
        ...
        "rate" DOUBLE PRECISION NOT NULL DEFAULT 0,
        "trucksOrdered" INTEGER,
        "truckCount" INTEGER,
        "qtyPerTruck" DOUBLE PRECISION,
