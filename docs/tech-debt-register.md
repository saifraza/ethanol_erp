...
**Mitigation**: Key contracts (1-4) documented in `.claude/skills/weighbridge/SKILL.md` "Cross-System API Contracts" section. Others documented in respective skill files.
